...
<div align="center">
<img src="https://skillicons.dev/icons?i=py,pytorch,fastapi,docker,mysql,sqlite,aws,linux,git,github" />
</div>
...
`CNNs` `RNNs` `Transfer Learning` `Transformers` `End-to-End ML Pipelines` `Feature Engineering` `LLM Fundamentals` `RAG Systems`
